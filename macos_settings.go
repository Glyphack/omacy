	...
	return []settingGroup{
		...
		},
		{
			...
			settings: []setting{
				...
				{
					// The sort column sits inside nested dictionaries that defaults cannot reach,
					// so plutil writes it. It fails when Finder has not written the view settings
					// yet, and there is nothing to do in that case.
				...
				{
					explanation: "Shows hidden files, the ones whose name starts with a dot, and the extension of every file.",
					commands: []string{
		...
		},
		{
			...
			settings: []setting{
				...
				{
					explanation: "Makes Zed the app that opens text files.",
					commands:    []string{"duti -s dev.zed.Zed public.text all"},
					optional:    true,
				},
				{
					explanation: "Makes Brave the default web browser.",
					commands: []string{
